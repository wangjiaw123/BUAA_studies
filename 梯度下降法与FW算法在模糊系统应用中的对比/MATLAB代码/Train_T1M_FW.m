function [xt_opt,Error_train,time_train,t_FW] = Train_T1M_FW (xtrain,ytrain,x0,bound_low,bound_up,M,I,error_precision,epsilon)
%%                   
...
Error_train = [];
%rho = 0.5;
while Err > error_precision  && t_FW<=5000   %停止条件
    gama = 2/(t_FW+2);
    if t_FW == 1
        xt = x0;
    end
