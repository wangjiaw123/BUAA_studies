...
%CORE_NUMBER_WIDTH=1;
DATA_SIZE = 3;%7  %max_select_train/data_size=7                              
...
for core_num=6   %2:2:CORE_NUMBER %   %核心数的循环
...
% save('M_SAVEParallel_performance_parameter.mat','SAVEparallel_total_time_A','SAVEparallel_interior_time_B',...
...
% save('M_SAVEdata_parallel_parameter','SAVE_parallel_M1','SAVE_parallel_M2','SAVE_parallel_sigma',...
%     'SAVE_parallel_c1','SAVE_parallel_c2','SAVE_parallel_Ytest','SAVE_parallel_Ypridect')
% save('M_SAVEdata_serial_parameter','SAVE_serial_M1','SAVE_serial_M2','SAVE_serial_sigma',...
%     'SAVE_serial_c1','SAVE_serial_c2','SAVE_serial_Ytest','SAVE_serial_Ypridect')
% save('M_SAVEdata_MEAN','SAVEparallel_total_time_A_MEAN','SAVEparallel_interior_time_B_MEAN',...
