...
SAVEserial_total_time = zeros(RULE_NUMBER,DATA_SIZE,Monte_carlo);        %1维是规则数的个数，2维是数据规模数的个数
SAVE_RMSE_serial    = zeros(RULE_NUMBER,Tmax,DATA_SIZE,Monte_carlo);     %维是规则数的个数，2维是Tmax(这一维用于存储RMSE),3维是数据规模数的个数
